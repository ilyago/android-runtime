describe("Tests string conversion ", function () {
	...
	it("TestCanConvertNonTrivalJavaString1", function () {
		...
		var strConvTest = new com.tns.tests.StringConversionTest(com.tns.NativeScriptApplication.getInstance());
	...
	it("TestCanConvertNonTrivalJavaString4", function () {
		...
		var strConvTest = new MyStringConversionTest(com.tns.NativeScriptApplication.getInstance());
